...
public class AutoStartHelper {
    ...
    public void getAutoStartPermission(Context context) {
        sharedpreferences = context.getSharedPreferences(MainActivity.ACTIVITY_SERVICE, MODE_PRIVATE);
        editor = context.getSharedPreferences(MainActivity.ACTIVITY_SERVICE, MODE_PRIVATE).edit();
